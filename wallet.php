        ...
        <div class="container mt-3 mb-4 text-center">
            ...
            <div class="avatar avatar-120 rounded mb-3">
                <div class="background">
                    <img src="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=<? echo "" . $installdir . "/". $row['myrefid']; ?>" title="Link to Google.com" />
                </div>
            </div>

            <h2 class="text-white"><? echo $row['myrefid']; ?></h2>
            <p class="text-white mb-4">My Referral ID</p>
        </div>
