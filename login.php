...
<head>
    ...
    <title>OnetBank - Activate and Earn</title>
...
<body class="body-scroll d-flex flex-column h-100 menu-overlay" data-page="landing">
        ...
        <div class="row h-100">
            <div class="align-self-center col">
                <div class="logo-loading">
                    ...
                    <h4 class="text-default">OnetBank</h4>
                            ...
                            <div class="col align-self-center px-3">
                                ...
                                <div class="row">
                                    <div class="container mb-5">
                                        ...
                                        <p>Use your network source and maximise profit.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col align-self-center px-3">
                                ...
                                <div class="row">
                                    <div class="container mb-5">
                                        ...
                                        <p>No hidden charge. Maximum profit is in your wallet</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="footer no-bg-shadow py-3">
        <div class="row justify-content-center">
            <div class="col">
                <a href="login-step.php" class="btn btn-default rounded btn-block">Login</a>
            </div>
            <div class="col">
